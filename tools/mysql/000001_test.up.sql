...
INSERT INTO `images` (`id`, `original_url`, `thumbnail_url`, `alt`, `height`, `width`, `author_email`)
VALUES (UUID_TO_BIN('660b8122-ac8f-11ed-8805-80e82cb6b6a3'), 'http://example.com/original.jpg', 'http://example.com/thumbnail.jpg', 'Example', 1920, 1080, 'author@example.com');
